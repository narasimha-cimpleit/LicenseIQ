...
- **Admin Page Layout Standardization** (2025-11-24): Completed conversion of 6 admin pages to use MainLayout component for consistent sidebar navigation across the application. Updated pages: master-data-mapping.tsx, erp-catalog.tsx, licenseiq-schema.tsx, master-data.tsx, admin-leads.tsx, and configuration.tsx. Removed custom headers, back buttons, and breadcrumbs in favor of unified navigation experience via persistent sidebar. Master-data.tsx now uses MainLayout's actions prop to display status filter and add company button in header. All pages verified working correctly with workflow running successfully.
